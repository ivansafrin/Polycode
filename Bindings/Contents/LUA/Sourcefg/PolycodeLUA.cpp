...
int luaopen_Polycode(lua_State *L) {
	static const struct luaL_reg polycoreLib [] = {		{"OSFILE_get_fileType", Polycore_OSFILE_get_fileType},
		...
		{"Camera_getLocalShaderOptions", Polycore_Camera_getLocalShaderOptions},
		...
		{"Core_getVideoModes", Polycore_Core_getVideoModes},
		...
		{"CoreServices_get_drawScreensFirst", Polycore_CoreServices_get_drawScreensFirst},
		{"CoreServices_set_drawScreensFirst", Polycore_CoreServices_set_drawScreensFirst},
		...
		{"Entity_get_billboardIgnoreScale", Polycore_Entity_get_billboardIgnoreScale},
		...
		{"Entity_get_position", Polycore_Entity_get_position},
		{"Entity_get_scale", Polycore_Entity_get_scale},
		{"Entity_get_rotation", Polycore_Entity_get_rotation},
		...
		{"Entity_set_billboardIgnoreScale", Polycore_Entity_set_billboardIgnoreScale},
		...
		{"FontManager_getNumFonts", Polycore_FontManager_getNumFonts},
		{"FontManager_getFontEntryByIndex", Polycore_FontManager_getFontEntryByIndex},
		{"FontManager_getFontEntryByFontPath", Polycore_FontManager_getFontEntryByFontPath},
		{"FontManager_removeFontEntry", Polycore_FontManager_removeFontEntry},
		...
		{"Image_gaussianBlur", Polycore_Image_gaussianBlur},
		{"Image_createKernel", Polycore_Image_createKernel},
		...
		{"Label_computeStringBbox", Polycore_Label_computeStringBbox},
		{"Label_precacheGlyphs", Polycore_Label_precacheGlyphs},
		{"Label_renderGlyphs", Polycore_Label_renderGlyphs},
		{"Label_drawGlyphBitmap", Polycore_Label_drawGlyphBitmap},
		...
		{"MaterialManager_registerShader", Polycore_MaterialManager_registerShader},
		...
		{"Mesh_getConnectedFaces", Polycore_Mesh_getConnectedFaces},
		...
		{"ScreenParticleEmitter_getParticleCompoundScale", Polycore_ScreenParticleEmitter_getParticleCompoundScale},
		...
		{"SceneParticleEmitter_getParticleCompoundScale", Polycore_SceneParticleEmitter_getParticleCompoundScale},
		...
		{"ParticleEmitter_get_particleSize", Polycore_ParticleEmitter_get_particleSize},
		{"ParticleEmitter_get_emitterRadius", Polycore_ParticleEmitter_get_emitterRadius},
		{"ParticleEmitter_get_perlinModSize", Polycore_ParticleEmitter_get_perlinModSize},
		{"ParticleEmitter_get_perlinEnabled", Polycore_ParticleEmitter_get_perlinEnabled},
		{"ParticleEmitter_get_rotationSpeed", Polycore_ParticleEmitter_get_rotationSpeed},
		{"ParticleEmitter_get_emitterType", Polycore_ParticleEmitter_get_emitterType},
		...
		{"ParticleEmitter_set_particleSize", Polycore_ParticleEmitter_set_particleSize},
		{"ParticleEmitter_set_perlinModSize", Polycore_ParticleEmitter_set_perlinModSize},
		{"ParticleEmitter_set_perlinEnabled", Polycore_ParticleEmitter_set_perlinEnabled},
		{"ParticleEmitter_set_rotationSpeed", Polycore_ParticleEmitter_set_rotationSpeed},
		{"ParticleEmitter_set_emitterType", Polycore_ParticleEmitter_set_emitterType},
		...
		{"ParticleEmitter_getParticleBlendingMode", Polycore_ParticleEmitter_getParticleBlendingMode},
		...
		{"ParticleEmitter_getNumParticles", Polycore_ParticleEmitter_getNumParticles},
		{"ParticleEmitter_getParticleAtIndex", Polycore_ParticleEmitter_getParticleAtIndex},
		{"ParticleEmitter_resetAll", Polycore_ParticleEmitter_resetAll},
		...
		{"ParticleEmitter_getParticleCompoundScale", Polycore_ParticleEmitter_getParticleCompoundScale},
		...
		{"ParticleEmitter_getParticleTexture", Polycore_ParticleEmitter_getParticleTexture},
		{"ParticleEmitter_setParticleTexture", Polycore_ParticleEmitter_setParticleTexture},
		...
		{"Renderer_get_doClearBuffer", Polycore_Renderer_get_doClearBuffer},
		{"Renderer_set_exposureLevel", Polycore_Renderer_set_exposureLevel},
		{"Renderer_set_doClearBuffer", Polycore_Renderer_set_doClearBuffer},
		...
		{"Renderer_isScissorEnabled", Polycore_Renderer_isScissorEnabled},
		{"Renderer_enableScissor", Polycore_Renderer_enableScissor},
		{"Renderer_setScissorBox", Polycore_Renderer_setScissorBox},
		{"Renderer_getScissorBox", Polycore_Renderer_getScissorBox},
		...
		{"Renderer_getDataPointerForName", Polycore_Renderer_getDataPointerForName},
		{"Renderer_setRendererShaderParams", Polycore_Renderer_setRendererShaderParams},
		{"Renderer_initOSSpecific", Polycore_Renderer_initOSSpecific},
		{"Renderer_addShaderModule", Polycore_Renderer_addShaderModule},
		{"Renderer_test2DCoordinateInPolygon", Polycore_Renderer_test2DCoordinateInPolygon},
		...
		{"Renderer_getAreaLights", Polycore_Renderer_getAreaLights},
		{"Renderer_getSpotLights", Polycore_Renderer_getSpotLights},
		...
		{"ResourceManager_removeArchive", Polycore_ResourceManager_removeArchive},
		...
		{"SceneEntity_get_collisionShapeType", Polycore_SceneEntity_get_collisionShapeType},
		{"SceneEntity_set_castShadows", Polycore_SceneEntity_set_castShadows},
		{"SceneEntity_set_collisionShapeType", Polycore_SceneEntity_set_collisionShapeType},
		...
		{"SceneMesh_set_lightmapIndex", Polycore_SceneMesh_set_lightmapIndex},
		...
		{"Screen_get_rootEntity", Polycore_Screen_get_rootEntity},
		...
		{"Screen_addEntity", Polycore_Screen_addEntity},
		...
		{"Screen_getLocalShaderOptions", Polycore_Screen_getLocalShaderOptions},
		...
		{"ScreenEntity_get_width", Polycore_ScreenEntity_get_width},
		{"ScreenEntity_get_height", Polycore_ScreenEntity_get_height},
		...
		{"ScreenEntity_set_width", Polycore_ScreenEntity_set_width},
		{"ScreenEntity_set_height", Polycore_ScreenEntity_set_height},
		{"ScreenEntity", Polycore_ScreenEntity},
		{"ScreenEntity_addEntity", Polycore_ScreenEntity_addEntity},
		...
		{"ScreenEntity_getScreenConcatenatedMatrix", Polycore_ScreenEntity_getScreenConcatenatedMatrix},
		...
		{"ScreenEntity_getPositionMode", Polycore_ScreenEntity_getPositionMode},
		...
		{"ScreenEntity_setDefaultScreenOptions", Polycore_ScreenEntity_setDefaultScreenOptions},
		{"ScreenEntity_focusChild", Polycore_ScreenEntity_focusChild},
		{"ScreenEntity_focusNextChild", Polycore_ScreenEntity_focusNextChild},
		{"ScreenEntity_moveChildUp", Polycore_ScreenEntity_moveChildUp},
		{"ScreenEntity_moveChildDown", Polycore_ScreenEntity_moveChildDown},
		{"ScreenEntity_moveChildTop", Polycore_ScreenEntity_moveChildTop},
		{"ScreenEntity_moveChildBottom", Polycore_ScreenEntity_moveChildBottom},
		{"ScreenEntity_getPosition2D", Polycore_ScreenEntity_getPosition2D},
		{"ScreenEntity_getScreenPosition", Polycore_ScreenEntity_getScreenPosition},
		{"ScreenEntity_getScale2D", Polycore_ScreenEntity_getScale2D},
		{"ScreenEntity_isFocusable", Polycore_ScreenEntity_isFocusable},
		{"ScreenEntity_getHitbox", Polycore_ScreenEntity_getHitbox},
		{"ScreenEntity_setHitbox", Polycore_ScreenEntity_setHitbox},
		{"delete_ScreenEntity", Polycore_delete_ScreenEntity},
		{"ScreenEntityInstance", Polycore_ScreenEntityInstance},
		{"ScreenEntityInstance_parseObjectIntoCurve", Polycore_ScreenEntityInstance_parseObjectIntoCurve},
		{"ScreenEntityInstance_applyScreenShape", Polycore_ScreenEntityInstance_applyScreenShape},
		{"ScreenEntityInstance_loadObjectEntryIntoEntity", Polycore_ScreenEntityInstance_loadObjectEntryIntoEntity},
		{"ScreenEntityInstance_loadFromFile", Polycore_ScreenEntityInstance_loadFromFile},
		{"ScreenEntityInstance_getRootEntity", Polycore_ScreenEntityInstance_getRootEntity},
		{"ScreenEntityInstance_getFileName", Polycore_ScreenEntityInstance_getFileName},
		{"delete_ScreenEntityInstance", Polycore_delete_ScreenEntityInstance},
		...
		{"ScreenLabel_get_positionAtBaseline", Polycore_ScreenLabel_get_positionAtBaseline},
		{"ScreenLabel_set_positionAtBaseline", Polycore_ScreenLabel_set_positionAtBaseline},
		...
		{"ScreenLabel_Render", Polycore_ScreenLabel_Render},
		{"delete_ScreenLabel", Polycore_delete_ScreenLabel},
		{"ScreenLine", Polycore_ScreenLine},
		{"ScreenLine_setStart", Polycore_ScreenLine_setStart},
		{"ScreenLine_setEnd", Polycore_ScreenLine_setEnd},
		{"ScreenLine_ScreenLineBetweenEntities", Polycore_ScreenLine_ScreenLineBetweenEntities},
		...
		{"ScreenMesh_updateHitBox", Polycore_ScreenMesh_updateHitBox},
		...
		{"ScreenShape_get_strokeWidth", Polycore_ScreenShape_get_strokeWidth},
		{"ScreenShape_set_strokeEnabled", Polycore_ScreenShape_set_strokeEnabled},
		{"ScreenShape_set_strokeWidth", Polycore_ScreenShape_set_strokeWidth},
		...
		{"ScreenShape_getShapeType", Polycore_ScreenShape_getShapeType},
		{"ScreenShape_setShapeType", Polycore_ScreenShape_setShapeType},
		{"ScreenShape_setShapeSize", Polycore_ScreenShape_setShapeSize},
		{"ScreenShape_buildShapeMesh", Polycore_ScreenShape_buildShapeMesh},
		...
		{"ScreenSprite_showFrame", Polycore_ScreenSprite_showFrame},
		{"ScreenSprite_playAnimation", Polycore_ScreenSprite_playAnimation},
		{"ScreenSprite_Update", Polycore_ScreenSprite_Update},
		{"ScreenSprite_setSpriteSize", Polycore_ScreenSprite_setSpriteSize},
		{"ScreenSprite_getSpriteSize", Polycore_ScreenSprite_getSpriteSize},
		{"ScreenSprite_getFileName", Polycore_ScreenSprite_getFileName},
		{"ScreenSprite_recalculateSpriteDimensions", Polycore_ScreenSprite_recalculateSpriteDimensions},
		{"ScreenSprite_loadFromFile", Polycore_ScreenSprite_loadFromFile},
		{"ScreenSprite_Pause", Polycore_ScreenSprite_Pause},
		{"ScreenSprite_getNumAnimations", Polycore_ScreenSprite_getNumAnimations},
		{"ScreenSprite_getAnimationAtIndex", Polycore_ScreenSprite_getAnimationAtIndex},
		{"ScreenSprite_getCurrentAnimation", Polycore_ScreenSprite_getCurrentAnimation},
		{"ScreenSprite_updateSprite", Polycore_ScreenSprite_updateSprite},
		...
		{"ShaderBinding_getTexture", Polycore_ShaderBinding_getTexture},
