...
static int Polycore_BasicFile_get_file(lua_State *L) {
...
static int Polycore_BasicFile_read(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFile *inst = (BasicFile*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_BasicFile_write(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFile *inst = (BasicFile*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	void* ptr = (void*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_BasicFile_seek(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFile *inst = (BasicFile*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_BasicFile_tell(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFile *inst = (BasicFile*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_BasicFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_BasicFileProvider(lua_State *L) {
	BasicFileProvider *inst = new BasicFileProvider();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.BasicFileProvider");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_BasicFileProvider_openFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_BasicFileProvider_closeFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFileProvider *inst = (BasicFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_BasicFileProvider_addSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFileProvider *inst = (BasicFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_BasicFileProvider_removeSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BasicFileProvider *inst = (BasicFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String source = String(lua_tostring(L, 2));
...
static int Polycore_delete_BasicFileProvider(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_BezierCurve_get_evaluationAccuracy(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierCurve *inst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_BezierCurve_set_evaluationAccuracy(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierCurve *inst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_BezierCurve_getYValueAtX(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierCurve *inst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_BezierCurve_getTValueAtX(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierCurve *inst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_BezierCurve_setHeightCacheResolution(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierCurve *inst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_BezierCurve_rebuildHeightCache(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierCurve *inst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_BezierPoint_get_p1(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_BezierPoint_get_p2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierPoint *inst = (BezierPoint*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_BezierPoint_get_p3(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierPoint *inst = (BezierPoint*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_BezierPoint_set_p1(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierPoint *inst = (BezierPoint*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_BezierPoint_set_p2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierPoint *inst = (BezierPoint*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_BezierPoint_set_p3(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BezierPoint *inst = (BezierPoint*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_BezierPoint(lua_State *L) {
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.BezierPoint");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_BezierPoint(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Bone_get_finalMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Bone_get_baseRotation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Bone_get_baseScale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Bone_get_basePosition(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Bone_get_disableAnimation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Bone_set_finalMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 *argInst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Bone_set_baseRotation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Bone_set_baseScale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Bone_set_basePosition(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Bone_set_disableAnimation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Bone_rebuildFinalMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Bone_buildFinalMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	Matrix4 *retInst = new Matrix4();
...
static int Polycore_Bone_intializeBone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Bone *inst = (Bone*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Camera_get_topLeftOrtho(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_set_topLeftOrtho(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Camera_isAABBInFrustum(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Camera_setOrthoSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Camera_setFrustumMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Camera_setClippingPlanes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Camera_getNearClippingPlane(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_getFarClippingPlane(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_getParentScene(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_createProjectionMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	Matrix4 *retInst = new Matrix4();
...
static int Polycore_Camera_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
...
static int Polycore_Camera_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Camera_setCustomProjectionMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 matrix = *(Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Camera_getViewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_setViewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Camera_setOrthoSizeMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Camera_getOrthoSizeMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_setProjectionMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Camera_getProjectionMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Camera_projectRayFrom2DCoordinate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Camera_renderFullScreenQuad(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Camera_getShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
	...
	*retInst = inst->getShaderPass(index);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.ShaderPass");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}

static int Polycore_Camera_getNumShaderPasses(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Camera *inst = (Camera*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ConfigEntry_get_key(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ConfigEntry_get_configNamespace(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ConfigEntry_get_numVal(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ConfigEntry_get_stringVal(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ConfigEntry_get_isString(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ConfigEntry_set_key(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ConfigEntry_set_configNamespace(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
...
static int Polycore_ConfigEntry_set_numVal(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->numVal = param;
...
static int Polycore_ConfigEntry_set_stringVal(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
...
static int Polycore_ConfigEntry_set_isString(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ConfigEntry *inst = (ConfigEntry*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->isString = param;
...
static int Polycore_delete_ConfigEntry(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Config_setBoolValue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Config *inst = (Config*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String configNamespace = String(lua_tostring(L, 2));
...
static int Polycore_Config_getBoolValue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Config *inst = (Config*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String configNamespace = String(lua_tostring(L, 2));
...
static int Polycore_Core_get_deviceAttitude(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Core_set_deviceAttitude(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Quaternion *argInst = (Quaternion*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Core_fixedUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_systemUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getBackingXRes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getBackingYRes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getScreenWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getScreenHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_saveFilePicker(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	vector<CoreFileExtension> extensions = *(vector<CoreFileExtension>*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Core_handleVideoModeChange(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Core_flushRenderContext(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_prepareRenderContext(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_openFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_Core_closeFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	CoreFile* file = (CoreFile*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Core_addFileSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_Core_removeFileSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String type = String(lua_tostring(L, 2));
...
static int Polycore_Core_parseFolder(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_Core_systemParseFolder(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String pathString = String(lua_tostring(L, 2));
...
static int Polycore_Core_getResourcePathForFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_Core_getRefreshIntervalMs(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getTimeSleptMs(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getFixedTimestep(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Core_getTicksFloat(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Core *inst = (Core*) *((PolyBase**)lua_touserdata(L, 1));
	double *retInst = new double();
	*retInst = inst->getTicksFloat();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.double");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}
...
static int Polycore_VideoModeChangeInfo_get_xRes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_VideoModeChangeInfo_get_yRes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_VideoModeChangeInfo_get_fullScreen(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_VideoModeChangeInfo_get_vSync(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_VideoModeChangeInfo_get_aaLevel(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_VideoModeChangeInfo_get_anisotropyLevel(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_VideoModeChangeInfo_get_retinaSupport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_VideoModeChangeInfo_set_xRes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->xRes = param;
...
static int Polycore_VideoModeChangeInfo_set_yRes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->yRes = param;
...
static int Polycore_VideoModeChangeInfo_set_fullScreen(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_VideoModeChangeInfo_set_vSync(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->vSync = param;
...
static int Polycore_VideoModeChangeInfo_set_aaLevel(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->aaLevel = param;
...
static int Polycore_VideoModeChangeInfo_set_anisotropyLevel(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_VideoModeChangeInfo_set_retinaSupport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VideoModeChangeInfo *inst = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_delete_VideoModeChangeInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_PolycodeViewBase_get_resizable(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolycodeViewBase *inst = (PolycodeViewBase*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_PolycodeViewBase_set_resizable(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolycodeViewBase *inst = (PolycodeViewBase*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_DummyCore(lua_State *L) {
	DummyCore *inst = new DummyCore();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.DummyCore");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_DummyCore_Render(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_DummyCore_systemUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushboolean(L, inst->systemUpdate());
	return 1;
...
static int Polycore_DummyCore_setCursor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int cursorType = lua_tointeger(L, 2);
...
static int Polycore_DummyCore_createThread(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Threaded* target = (Threaded*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_DummyCore_createMutex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase *ptrRetVal = (PolyBase*)inst->createMutex();
	if(ptrRetVal == NULL) {
...
static int Polycore_DummyCore_copyStringToClipboard(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String str = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_getClipboardString(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->getClipboardString().c_str());
	return 1;
...
static int Polycore_DummyCore_createFolder(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String folderPath = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_copyDiskItem(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String itemPath = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_moveDiskItem(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String itemPath = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_removeDiskItem(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String itemPath = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_openFolderPicker(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->openFolderPicker().c_str());
	return 1;
...
static int Polycore_DummyCore_openFilePicker(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	vector<CoreFileExtension> extensions = *(vector<CoreFileExtension>*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_DummyCore_saveFilePicker(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	vector<CoreFileExtension> extensions = *(vector<CoreFileExtension>*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_DummyCore_handleVideoModeChange(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VideoModeChangeInfo* modeInfo = (VideoModeChangeInfo*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_DummyCore_flushRenderContext(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	inst->flushRenderContext();
	return 0;
...
static int Polycore_DummyCore_openURL(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String url = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_getTicks(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getTicks());
	return 1;
...
static int Polycore_DummyCore_executeExternalCommand(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String command = String(lua_tostring(L, 2));
...
static int Polycore_DummyCore_systemParseFolder(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	DummyCore *inst = (DummyCore*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String pathString = String(lua_tostring(L, 2));
...
static int Polycore_delete_DummyCore(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_TimeInfo_get_seconds(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_TimeInfo_get_minutes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_get_hours(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_get_month(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_get_monthDay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_get_weekDay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_get_year(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_get_yearDay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_TimeInfo_set_seconds(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->seconds = param;
...
static int Polycore_TimeInfo_set_minutes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->minutes = param;
...
static int Polycore_TimeInfo_set_hours(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->hours = param;
...
static int Polycore_TimeInfo_set_month(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->month = param;
...
static int Polycore_TimeInfo_set_monthDay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->monthDay = param;
...
static int Polycore_TimeInfo_set_weekDay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->weekDay = param;
...
static int Polycore_TimeInfo_set_year(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->year = param;
...
static int Polycore_TimeInfo_set_yearDay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TimeInfo *inst = (TimeInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->yearDay = param;
...
static int Polycore_TimeInfo(lua_State *L) {
	TimeInfo *inst = new TimeInfo();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.TimeInfo");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_TimeInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_CoreMutex_get_mutexID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_CoreMutex_set_mutexID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreMutex *inst = (CoreMutex*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->mutexID = param;
...
static int Polycore_CoreMutex_lock(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreMutex *inst = (CoreMutex*) *((PolyBase**)lua_touserdata(L, 1));
	inst->lock();
	return 0;
...
static int Polycore_CoreMutex_unlock(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreMutex *inst = (CoreMutex*) *((PolyBase**)lua_touserdata(L, 1));
	inst->unlock();
	return 0;
...
static int Polycore_delete_CoreMutex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_CoreMotionEvent_get_amount(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_CoreMotionEvent_set_amount(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreMotionEvent *inst = (CoreMotionEvent*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_delete_CoreMotionEvent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_CoreFileExtension_get_extension(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_CoreFileExtension_get_description(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreFileExtension *inst = (CoreFileExtension*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_CoreFileExtension_set_extension(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreFileExtension *inst = (CoreFileExtension*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
...
static int Polycore_CoreFileExtension_set_description(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreFileExtension *inst = (CoreFileExtension*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
...
static int Polycore_CoreFileExtension(lua_State *L) {
	CoreFileExtension *inst = new CoreFileExtension();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.CoreFileExtension");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_CoreFileExtension(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_OSFileEntry(lua_State *L) {
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.OSFileEntry");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_OSFileEntry_init(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OSFileEntry *inst = (OSFileEntry*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_CoreInput_get_simulateTouchAsPen(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_CoreInput_get_simulateMouseWithTouch(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_CoreInput_get_ignoreOffScreenTouch(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_CoreInput_get_keyRepeat(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_CoreInput_set_simulateTouchAsPen(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_CoreInput_set_simulateMouseWithTouch(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_CoreInput_set_ignoreOffScreenTouch(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_CoreInput_set_keyRepeat(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreInput *inst = (CoreInput*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_JoystickInfo_get_deviceID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_JoystickInfo_get_deviceIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	JoystickInfo *inst = (JoystickInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_JoystickInfo_set_deviceID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	JoystickInfo *inst = (JoystickInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->deviceID = param;
...
static int Polycore_JoystickInfo_set_deviceIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	JoystickInfo *inst = (JoystickInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_JoystickInfo(lua_State *L) {
	JoystickInfo *inst = new JoystickInfo();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.JoystickInfo");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_JoystickInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_CoreServices_createInstance(lua_State *L) {
...
static int Polycore_CoreServices_fixedUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreServices *inst = (CoreServices*) *((PolyBase**)lua_touserdata(L, 1));
	inst->fixedUpdate();
	return 0;
...
static int Polycore_CoreServices_getInput(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	CoreServices *inst = (CoreServices*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase *ptrRetVal = (PolyBase*)inst->getInput();
	if(ptrRetVal == NULL) {
...
static int Polycore_MouseEventResult_get_hit(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_MouseEventResult_get_blocked(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MouseEventResult *inst = (MouseEventResult*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_MouseEventResult_set_hit(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MouseEventResult *inst = (MouseEventResult*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->hit = param;
...
static int Polycore_MouseEventResult_set_blocked(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MouseEventResult *inst = (MouseEventResult*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->blocked = param;
...
static int Polycore_delete_MouseEventResult(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_EntityProp_get_propName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_EntityProp_get_propValue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	EntityProp *inst = (EntityProp*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_EntityProp_set_propName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	EntityProp *inst = (EntityProp*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->propName = param;
...
static int Polycore_EntityProp_set_propValue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	EntityProp *inst = (EntityProp*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
...
static int Polycore_delete_EntityProp(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_AABB_get_min(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_AABB_get_max(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AABB *inst = (AABB*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_AABB_set_min(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AABB *inst = (AABB*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_AABB_set_max(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AABB *inst = (AABB*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_delete_AABB(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
	delete ((AABB*) *inst);
	*inst = NULL;
...
static int Polycore_Entity_get_collisionShapeType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Entity_get_processInputEvents(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_get_blockMouseInput(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_get_snapToPixels(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_get_mouseOver(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_get_rendererVis(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_get_layerID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Entity_set_collisionShapeType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_set_processInputEvents(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_set_blockMouseInput(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_set_snapToPixels(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_set_mouseOver(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_set_rendererVis(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_set_layerID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	char *argInst = (char*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_initEntity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	inst->initEntity();
	return 0;
...
static int Polycore_Entity_fixedUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	inst->fixedUpdate();
	return 0;
...
static int Polycore_Entity_getAnchorAdjustedMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	Matrix4 *retInst = new Matrix4();
...
static int Polycore_Entity_getPosition2D(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	Vector2 *retInst = new Vector2();
...
static int Polycore_Entity_getRotationEuler(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_Entity_setRotationEuler(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_getWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_getHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_getDepth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_setWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Entity_setHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Entity_setDepth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Entity_setRotationByQuaternion(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_getConcatenatedQuat(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	Quaternion *retInst = new Quaternion();
...
static int Polycore_Entity_setAnchorPoint(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_getAnchorPoint(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_Entity_onMouseDown(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_onMouseUp(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Ray ray = *(Ray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_onMouseMove(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Ray ray = *(Ray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_onMouseWheelUp(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Ray ray = *(Ray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_onMouseWheelDown(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Ray ray = *(Ray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_setDepthOnly(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_getDepthOnly(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_getBlendingMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_getEntitiesByLayerID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_setInverseY(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_Entity_getInverseY(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_doFixedUpdates(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	inst->doFixedUpdates();
	return 0;
...
static int Polycore_Entity_customHitDetection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Ray ray = *(Ray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_getScreenPosition(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_recalculateAABBAllChildren(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_recalculateAABB(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_getWorldAABB(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	AABB *retInst = new AABB();
	*retInst = inst->getWorldAABB();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.AABB");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}

static int Polycore_Entity_getLocalBoundingBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_Entity_setLocalBoundingBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_setLocalBoundingBoxX(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_Entity_setLocalBoundingBoxY(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number y = lua_tonumber(L, 2);
...
static int Polycore_Entity_setLocalBoundingBoxZ(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number z = lua_tonumber(L, 2);
...
static int Polycore_Entity_setContainerScene(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_getContainerScene(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_attachScript(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Entity_detachScript(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Script* script = (Script*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Entity_getNumScripts(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Entity_getScriptAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Entity *inst = (Entity*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_Event_get_cancelEventFlag(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Event *inst = (Event*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Event_set_cancelEventFlag(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Event *inst = (Event*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Event_cancelEvent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Event *inst = (Event*) *((PolyBase**)lua_touserdata(L, 1));
	inst->cancelEvent();
	return 0;
...
static int Polycore_EventDispatcher_addEventListenerUnique(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	EventDispatcher *inst = (EventDispatcher*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	EventHandler* handler = (EventHandler*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_EventDispatcher_hasEventListener(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	EventDispatcher *inst = (EventDispatcher*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	EventHandler* handler = (EventHandler*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_LightInfo_get_importance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_LightInfo_get_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_LightInfo_get_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_LightInfo_get_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->type);
	return 1;
...
static int Polycore_LightInfo_get_diffuseColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_LightInfo_get_specularColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_LightInfo_get_constantAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_linearAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_quadraticAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_intensity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_spotlightCutoff(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_spotlightExponent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_shadowsEnabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_shadowMapTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfo_get_lightViewMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_LightInfo_set_importance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_LightInfo_set_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_LightInfo_set_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_LightInfo_set_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->type = param;
...
static int Polycore_LightInfo_set_diffuseColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_LightInfo_set_specularColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_LightInfo_set_constantAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_LightInfo_set_linearAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_LightInfo_set_quadraticAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_LightInfo_set_intensity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_LightInfo_set_spotlightCutoff(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_LightInfo_set_spotlightExponent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_LightInfo_set_shadowsEnabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_LightInfo_set_lightViewMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfo *inst = (LightInfo*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 *argInst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_delete_LightInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_GPUDrawCall_get_mesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_GPUDrawCall_get_options(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawCall *inst = (GPUDrawCall*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawCall_get_modelMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawCall *inst = (GPUDrawCall*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawCall_get_material(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawCall *inst = (GPUDrawCall*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->material) {
		lua_pushnil(L);
...
static int Polycore_GPUDrawCall_set_options(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawCall *inst = (GPUDrawCall*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_GPUDrawCall_set_modelMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawCall *inst = (GPUDrawCall*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 *argInst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_delete_GPUDrawCall(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_GPUDrawOptions_get_depthTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_GPUDrawOptions_get_depthWrite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushboolean(L, inst->depthWrite);
	return 1;
...
static int Polycore_GPUDrawOptions_get_linePointSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawOptions_get_alphaTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawOptions_get_backfaceCull(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawOptions_get_depthOnly(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawOptions_get_forceMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawOptions_get_blendingMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawOptions_get_scissorBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->scissorBox;
...
static int Polycore_GPUDrawOptions_get_enableScissor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushboolean(L, inst->enableScissor);
	return 1;
...
static int Polycore_GPUDrawOptions_get_drawColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawOptions_set_depthTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->depthTest = param;
...
static int Polycore_GPUDrawOptions_set_depthWrite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->depthWrite = param;
...
static int Polycore_GPUDrawOptions_set_linePointSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_GPUDrawOptions_set_alphaTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_GPUDrawOptions_set_backfaceCull(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_GPUDrawOptions_set_depthOnly(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_GPUDrawOptions_set_forceMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_GPUDrawOptions_set_blendingMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_GPUDrawOptions_set_scissorBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Rectangle *argInst = (Rectangle*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawOptions_set_enableScissor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->enableScissor = param;
...
static int Polycore_GPUDrawOptions_set_drawColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawOptions *inst = (GPUDrawOptions*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_delete_GPUDrawOptions(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_GPUDrawBuffer_get_targetFramebuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_GPUDrawBuffer_get_projectionMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawBuffer_get_viewMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawBuffer_get_cameraMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawBuffer_get_clearColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawBuffer_get_clearDepthBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawBuffer_get_clearColorBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawBuffer_get_backingResolutionScale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawBuffer_get_globalMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_GPUDrawBuffer_get_viewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_GPUDrawBuffer_set_projectionMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 *argInst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawBuffer_set_viewMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 *argInst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawBuffer_set_cameraMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 *argInst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawBuffer_set_clearColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawBuffer_set_clearDepthBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_GPUDrawBuffer_set_clearColorBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_GPUDrawBuffer_set_backingResolutionScale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector2 *argInst = (Vector2*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawBuffer_set_viewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	GPUDrawBuffer *inst = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Rectangle *argInst = (Rectangle*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_GPUDrawBuffer(lua_State *L) {
	GPUDrawBuffer *inst = new GPUDrawBuffer();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.GPUDrawBuffer");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_GPUDrawBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_TouchInfo_get_id(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_TouchInfo_get_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TouchInfo *inst = (TouchInfo*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->position;
...
static int Polycore_TouchInfo_get_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TouchInfo *inst = (TouchInfo*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->type);
	return 1;
...
static int Polycore_TouchInfo_set_id(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TouchInfo *inst = (TouchInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->id = param;
...
static int Polycore_TouchInfo_set_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TouchInfo *inst = (TouchInfo*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector2 *argInst = (Vector2*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_TouchInfo_set_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	TouchInfo *inst = (TouchInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->type = param;
...
static int Polycore_TouchInfo(lua_State *L) {
	TouchInfo *inst = new TouchInfo();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.TouchInfo");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_TouchInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_InputEvent_get_touchType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	InputEvent *inst = (InputEvent*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_InputEvent_get_hitDistance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	InputEvent *inst = (InputEvent*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_InputEvent_set_touchType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	InputEvent *inst = (InputEvent*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_InputEvent_set_hitDistance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	InputEvent *inst = (InputEvent*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_InputEvent_getCharCode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	InputEvent *inst = (InputEvent*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ColorRange_get_color(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ColorRange_get_rangeStart(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ColorRange *inst = (ColorRange*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ColorRange_get_rangeEnd(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ColorRange *inst = (ColorRange*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ColorRange_set_color(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ColorRange *inst = (ColorRange*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ColorRange_set_rangeStart(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ColorRange *inst = (ColorRange*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_ColorRange_set_rangeEnd(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ColorRange *inst = (ColorRange*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->rangeEnd = param;
...
static int Polycore_ColorRange(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ColorRange");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_ColorRange(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Label_getPremultiplyAlpha(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Label_setPremultiplyAlpha(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_Label_setBackgroundColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color color = *(Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Label_setForegroundColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color color = *(Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Label_setColors(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Label_getBackgroundColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
	Color *retInst = new Color();
...
static int Polycore_Label_getForegroundColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Label *inst = (Label*) *((PolyBase**)lua_touserdata(L, 1));
	Color *retInst = new Color();
...
static int Polycore_Material_addShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Material *inst = (Material*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Material_addShaderPassAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Material *inst = (Material*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ShaderPass pass = *(ShaderPass*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Material_getNumShaderPasses(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Material *inst = (Material*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getNumShaderPasses());
	return 1;
...
static int Polycore_Material_removeShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Material *inst = (Material*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Material_recreateExpectedShaderParams(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Material *inst = (Material*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Material_getShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Material *inst = (Material*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_ShaderPass_get_shader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ShaderPass_get_wireframe(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderPass_get_blendingMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->blendingMode);
	return 1;
...
static int Polycore_ShaderPass_get_shaderBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderPass_get_materialShaderBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderPass_set_wireframe(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_ShaderPass_set_blendingMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->blendingMode = param;
...
static int Polycore_ShaderPass(lua_State *L) {
...
static int Polycore_ShaderPass_setAttributeArraysFromMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_ShaderPass_setExpectedAttributes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderPass *inst = (ShaderPass*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderPass_arrayToAttributeName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_ShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_MaterialManager_get_keepTextureData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MaterialManager *inst = (MaterialManager*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_MaterialManager_set_keepTextureData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MaterialManager *inst = (MaterialManager*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_MaterialManager_loadMaterialLibraryIntoPool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MaterialManager *inst = (MaterialManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_MaterialManager_setAnisotropyAmount(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MaterialManager *inst = (MaterialManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_MaterialManager_setTextureFilteringMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MaterialManager *inst = (MaterialManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_MaterialManager_getTextureFilteringMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	MaterialManager *inst = (MaterialManager*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Matrix4_multiplyWithPerspective(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 v2 = *(Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Matrix4_multVector3(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 v2 = *(Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Matrix4_multVector4(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	...
	*retInst = inst->multVector4(v2);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore. Vector4");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}

static int Polycore_Matrix4_Translate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_Matrix4_setOrthoProjection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number left = lua_tonumber(L, 2);
...
static int Polycore_Matrix4_setProjectionFrustum(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number left = lua_tonumber(L, 2);
...
static int Polycore_Matrix4_setProjection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Matrix4 *inst = (Matrix4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number fov = lua_tonumber(L, 2);
...
static int Polycore_Mesh_get_indexedMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Mesh_get_vertexPositionArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexColorArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexNormalArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexTexCoordArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexTexCoord2Array(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexTangentArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexBoneWeightArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_vertexBoneIndexArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_get_indexArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Mesh_set_indexedMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Mesh_set_vertexPositionArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Mesh_set_vertexColorArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_vertexNormalArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_vertexTexCoordArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_vertexTexCoord2Array(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_vertexTangentArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_vertexBoneWeightArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_vertexBoneIndexArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	VertexDataArray *argInst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Mesh_set_indexArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Mesh_createCircle(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number w = lua_tonumber(L, 2);
...
static int Polycore_Mesh_createLineCircle(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number w = lua_tonumber(L, 2);
...
static int Polycore_Mesh_createIcosphere(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number radius = lua_tonumber(L, 2);
...
static int Polycore_Mesh_createOctosphere(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number radius = lua_tonumber(L, 2);
...
static int Polycore_Mesh_setVertexAtOffset(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int offset = lua_tointeger(L, 2);
...
static int Polycore_Mesh_addVertexWithUVAndNormal(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_Mesh_addTexCoord(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_addTexCoord2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number u = lua_tonumber(L, 2);
...
static int Polycore_Mesh_addTangent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_Mesh_addVertexWithUV(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_Mesh_addNormal(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_addBoneAssignments(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_addColor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number r = lua_tonumber(L, 2);
...
static int Polycore_Mesh_getVertexPosition(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_getVertexPositionAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_Mesh_getVertexTexCoord(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int vertexOffset = lua_tointeger(L, 2);
...
static int Polycore_Mesh_getVertexTexCoordAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_Mesh_Copy(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Mesh_getIndexGroupSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	 unsigned int *retInst = new  unsigned int();
	*retInst = inst->getIndexGroupSize();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore. unsigned int");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}
...
static int Polycore_Mesh_addIndexedFace(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_addIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_Mesh_removeVertexRange(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_removeFace(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Mesh_removeUnusedVertices(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Mesh_getIndexCount(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Mesh_subdivideToRadius(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number radius = lua_tonumber(L, 2);
...
static int Polycore_Mesh_calculateFaceTangent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Mesh_saveAsOBJ(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_Mesh_normalizeBoneWeights(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Mesh *inst = (Mesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_OpenGLGraphicsInterface_get_lineSmooth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_set_lineSmooth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_OpenGLGraphicsInterface(lua_State *L) {
	OpenGLGraphicsInterface *inst = new OpenGLGraphicsInterface();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.OpenGLGraphicsInterface");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_OpenGLGraphicsInterface_createTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Texture* texture = (Texture*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_destroyTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Texture* texture = (Texture*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_setViewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int x = lua_tointeger(L, 2);
...
static int Polycore_OpenGLGraphicsInterface_clearBuffers(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_setParamInShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_setAttributeInShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_disableAttribute(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_useShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_createProgram(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_destroyProgram(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ShaderProgram* program = (ShaderProgram*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_createVBOForVertexArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_createMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Mesh* mesh = (Mesh*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_destroyMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Mesh* mesh = (Mesh*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_createShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_destroyShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_OpenGLGraphicsInterface_beginDrawCall(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	inst->beginDrawCall();
	return 0;
...
static int Polycore_OpenGLGraphicsInterface_endDrawCall(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	inst->endDrawCall();
	return 0;
...
static int Polycore_OpenGLGraphicsInterface_setBlendingMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_OpenGLGraphicsInterface_createRenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	RenderBuffer* r_enderBuffer = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 2));
	inst->createRenderBuffer(r_enderBuffer);
	return 0;
}

static int Polycore_OpenGLGraphicsInterface_destroyRenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	RenderBuffer* r_enderBuffer = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 2));
	inst->destroyRenderBuffer(r_enderBuffer);
	return 0;
}

static int Polycore_OpenGLGraphicsInterface_bindRenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	RenderBuffer* r_enderBuffer = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 2));
	inst->bindRenderBuffer(r_enderBuffer);
	return 0;
}

static int Polycore_OpenGLGraphicsInterface_createVertexBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_createIndexBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_destroyBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_OpenGLGraphicsInterface_drawIndices(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_OpenGLGraphicsInterface_drawArrays(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int type = lua_tointeger(L, 2);
...
static int Polycore_OpenGLGraphicsInterface_enableDepthTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_OpenGLGraphicsInterface_enableDepthWrite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_OpenGLGraphicsInterface_enableBackfaceCulling(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_OpenGLGraphicsInterface_setLineSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_OpenGLGraphicsInterface_setWireframeMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_OpenGLGraphicsInterface_enableScissor(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_OpenGLGraphicsInterface_setScissorBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	OpenGLGraphicsInterface *inst = (OpenGLGraphicsInterface*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_delete_OpenGLGraphicsInterface(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneParticle_get_lifetime(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneParticle_get_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->position;
...
static int Polycore_SceneParticle_get_velocity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticle_get_perlinPos(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticle_get_rotation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticle_get_brightnessDeviation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticle_get_scale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticle_get_color(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->color;
...
static int Polycore_SceneParticle_get_varianceIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticle_set_lifetime(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->lifetime = param;
...
static int Polycore_SceneParticle_set_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticle_set_velocity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticle_set_perlinPos(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticle_set_rotation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticle_set_brightnessDeviation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_SceneParticle_set_scale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->scale = param;
...
static int Polycore_SceneParticle_set_color(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticle_set_varianceIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticle *inst = (SceneParticle*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_delete_SceneParticle(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneParticleEmitter_get_useScaleCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_get_scaleCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticleEmitter_get_useColorCurves(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_get_colorCurveR(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticleEmitter_get_colorCurveG(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticleEmitter_get_colorCurveB(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticleEmitter_get_colorCurveA(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticleEmitter_get_colorDeviation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SceneParticleEmitter_set_useScaleCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_set_scaleCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_set_useColorCurves(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_set_colorCurveR(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	BezierCurve *argInst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_set_colorCurveG(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	BezierCurve *argInst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_set_colorCurveB(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	BezierCurve *argInst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_set_colorCurveA(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	BezierCurve *argInst = (BezierCurve*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_set_colorDeviation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Color *argInst = (Color*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_setParticleCount(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneParticleEmitter_getParticleCount(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_setParticleLifetime(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number lifetime = lua_tonumber(L, 2);
...
static int Polycore_SceneParticleEmitter_getParticleLifetime(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_setDirectionDeviation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_getDirectionDeviation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneParticleEmitter_setEmitterSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_getEmitterSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneParticleEmitter_setGravity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_getGravity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneParticleEmitter_fixedUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	inst->fixedUpdate();
	return 0;
...
static int Polycore_SceneParticleEmitter_Render(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	GPUDrawBuffer* buffer = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_updateParticles(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_rebuildParticles(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	GPUDrawBuffer* buffer = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_triggerParticles(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
...
static int Polycore_SceneParticleEmitter_enableParticleSystem(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_setUseFloorPlane(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_setFloorPlaneOffset(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneParticleEmitter_setFloorDamping(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneParticleEmitter_setParticlesInWorldSpace(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_getParticlesInWorldSpace(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_setPerlinEnabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_getPerlinEnabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_getParticleSpeed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_setParticleSpeed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneParticleEmitter_setPerlinValue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_getPerlinValue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneParticleEmitter_setParticleType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneParticleEmitter_getParticleType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_setParticleSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneParticleEmitter_getParticleSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_setParticleRotationSpeed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_getParticleRotationSpeed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneParticleEmitter_setParticleDirection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneParticleEmitter_getParticleDirection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneParticleEmitter_setLoopParticles(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_getLoopParticles(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_addSourceMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Mesh* mesh = (Mesh*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneParticleEmitter_getNumSourceMeshes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneParticleEmitter_getSourcesMeshAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SceneParticleEmitter_removeSourceMeshAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SceneParticleEmitter_positionParticle(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SceneParticleEmitter_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneParticleEmitter_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneParticleEmitter *inst = (SceneParticleEmitter*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_PhysFSFile_get_physFSFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_PhysFSFile_read(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFile *inst = (PhysFSFile*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	void* ptr = (void*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_PhysFSFile_write(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFile *inst = (PhysFSFile*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	void* ptr = (void*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_PhysFSFile_seek(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFile *inst = (PhysFSFile*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int offset = lua_tointeger(L, 2);
...
static int Polycore_PhysFSFile_tell(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFile *inst = (PhysFSFile*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->tell());
	return 1;
...
static int Polycore_delete_PhysFSFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_PhysFSFileProvider(lua_State *L) {
	PhysFSFileProvider *inst = new PhysFSFileProvider();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.PhysFSFileProvider");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_PhysFSFileProvider_openFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_PhysFSFileProvider_closeFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFileProvider *inst = (PhysFSFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	CoreFile* file = (CoreFile*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_PhysFSFileProvider_parseFolder(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFileProvider *inst = (PhysFSFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String pathString = String(lua_tostring(L, 2));
...
static int Polycore_PhysFSFileProvider_addSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFileProvider *inst = (PhysFSFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String source = String(lua_tostring(L, 2));
...
static int Polycore_PhysFSFileProvider_removeSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PhysFSFileProvider *inst = (PhysFSFileProvider*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String source = String(lua_tostring(L, 2));
...
static int Polycore_delete_PhysFSFileProvider(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_QuatTriple_get_q1(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_QuatTriple_get_q2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_QuatTriple_get_q3(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_QuatTriple_get_time(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_QuatTriple_set_q1(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Quaternion *argInst = (Quaternion*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_QuatTriple_set_q2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Quaternion *argInst = (Quaternion*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_QuatTriple_set_q3(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Quaternion *argInst = (Quaternion*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_QuatTriple_set_time(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	QuatTriple *inst = (QuatTriple*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->time = param;
...
static int Polycore_delete_QuatTriple(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Ray_get_origin(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Ray_get_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->direction;
...
static int Polycore_Ray_get_inv_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Ray_set_origin(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Ray_set_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Ray_set_inv_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Ray(lua_State *L) {
	Ray *inst = new Ray();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.Ray");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_Ray_boxIntersect(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 box = *(Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Ray_planeIntersectPoint(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Ray_tranformByMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 matrix = *(Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Ray_closestPointOnRay(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Ray_closestPointsBetween(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Ray_polygonIntersect(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Ray *inst = (Ray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_delete_Ray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
	delete ((Ray*) *inst);
	*inst = NULL;
...
static int Polycore_RenderDataArray_get_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RenderDataArray_get_customArrayName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderDataArray_get_hasVBO(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderDataArray_get_platformData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderDataArray_set_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->type = param;
...
static int Polycore_RenderDataArray_set_customArrayName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
...
static int Polycore_RenderDataArray_set_hasVBO(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->hasVBO = param;
...
static int Polycore_RenderDataArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TNUMBER);
	int type = lua_tointeger(L, 1);
	RenderDataArray *inst = new RenderDataArray(type);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.RenderDataArray");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_RenderDataArray_getArrayData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderDataArray_getDataSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderDataArray *inst = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_RenderDataArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_VertexDataArray_get_countPerVertex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_VertexDataArray_set_countPerVertex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VertexDataArray *inst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	char *argInst = (char*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_VertexDataArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.VertexDataArray");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_VertexDataArray_getCountPerVertex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VertexDataArray *inst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	unsigned char *retInst = new unsigned char();
	*retInst = inst->getCountPerVertex();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.unsigned char");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}

static int Polycore_VertexDataArray_getArrayData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VertexDataArray *inst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase *ptrRetVal = (PolyBase*)inst->getArrayData();
	if(ptrRetVal == NULL) {
...
static int Polycore_VertexDataArray_getDataSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	VertexDataArray *inst = (VertexDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getDataSize());
	return 1;
...
static int Polycore_delete_VertexDataArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_IndexDataArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TNUMBER);
	int type = lua_tointeger(L, 1);
	IndexDataArray *inst = new IndexDataArray(type);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.IndexDataArray");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_IndexDataArray_getArrayData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_IndexDataArray_getDataSize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	IndexDataArray *inst = (IndexDataArray*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getDataSize());
	return 1;
...
static int Polycore_delete_IndexDataArray(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_LightShadowInfoBinding_get_shadowMatrix(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_LightShadowInfoBinding_get_shadowBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightShadowInfoBinding *inst = (LightShadowInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_LightShadowInfoBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_LightInfoBinding_get_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_LightInfoBinding_get_direction(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->direction) {
		lua_pushnil(L);
...
static int Polycore_LightInfoBinding_get_specular(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->specular) {
		lua_pushnil(L);
...
static int Polycore_LightInfoBinding_get_diffuse(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->diffuse) {
		lua_pushnil(L);
...
static int Polycore_LightInfoBinding_get_spotExponent(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfoBinding_get_spotCosCutoff(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfoBinding_get_constantAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfoBinding_get_linearAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfoBinding_get_quadraticAttenuation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LightInfoBinding_get_shadowEnabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LightInfoBinding *inst = (LightInfoBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_LightInfoBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_RenderFrame_get_jobQueue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RenderFrame_set_jobQueue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderFrame *inst = (RenderFrame*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_delete_RenderFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_RendererThreadJob_get_jobType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RendererThreadJob_get_data(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RendererThreadJob *inst = (RendererThreadJob*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->data) {
		lua_pushnil(L);
...
static int Polycore_RendererThreadJob_get_data2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RendererThreadJob *inst = (RendererThreadJob*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->data2) {
		lua_pushnil(L);
...
static int Polycore_RendererThreadJob_set_jobType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RendererThreadJob *inst = (RendererThreadJob*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->jobType = param;
...
static int Polycore_delete_RendererThreadJob(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_RenderThread(lua_State *L) {
	RenderThread *inst = new RenderThread();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.RenderThread");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_RenderThread_setGraphicsInterface(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RenderThread_runThread(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	inst->runThread();
	return 0;
...
static int Polycore_RenderThread_enqueueFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_RenderThread_enqueueJob(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_RenderThread_processJob(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_RenderThread_getShaderBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderThread_processDrawBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	GPUDrawBuffer* buffer = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_RenderThread_getFrameInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	RenderThreadDebugInfo *retInst = new RenderThreadDebugInfo();
	*retInst = inst->getFrameInfo();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.RenderThreadDebugInfo");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}

static int Polycore_RenderThread_clearFrameQueue(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderThread_initGlobals(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
	inst->initGlobals();
	return 0;
...
static int Polycore_RenderThread_lockRenderMutex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderThread_unlockRenderMutex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThread *inst = (RenderThread*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_RenderThread(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_RenderThreadDebugInfo_get_buffersProcessed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RenderThreadDebugInfo_get_drawCallsProcessed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThreadDebugInfo *inst = (RenderThreadDebugInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderThreadDebugInfo_get_timeTaken(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThreadDebugInfo *inst = (RenderThreadDebugInfo*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderThreadDebugInfo_set_buffersProcessed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThreadDebugInfo *inst = (RenderThreadDebugInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_RenderThreadDebugInfo_set_drawCallsProcessed(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThreadDebugInfo *inst = (RenderThreadDebugInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_RenderThreadDebugInfo_set_timeTaken(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderThreadDebugInfo *inst = (RenderThreadDebugInfo*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_delete_RenderThreadDebugInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Renderer_setGraphicsInterface(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Renderer_getRenderThread(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Renderer_createRenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int width = lua_tointeger(L, 2);
...
static int Polycore_Renderer_destroyRenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Renderer_processDrawBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	GPUDrawBuffer* buffer = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_setBackingResolutionScale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Renderer_getBackingResolutionScaleX(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Renderer_getBackingResolutionScaleY(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Renderer_createProgram(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_Renderer_createShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Renderer_createVertexBuffers(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Mesh* mesh = (Mesh*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_enqueueFrameJob(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int jobType = lua_tointeger(L, 2);
...
static int Polycore_Renderer_destroyProgram(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ShaderProgram* program = (ShaderProgram*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_destroyShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Shader* shader = (Shader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_destroyBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	RenderDataArray* array = (RenderDataArray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_destroyShaderBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Renderer_destroyShaderParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Renderer_setTextureParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	LocalShaderParam* param = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_createMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_Renderer_destroyMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Mesh* mesh = (Mesh*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_project(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector3 position = *(Vector3*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Matrix4 modelMatrix = *(Matrix4*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Renderer_beginFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	inst->beginFrame();
	return 0;
...
static int Polycore_Renderer_endFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Renderer *inst = (Renderer*) *((PolyBase**)lua_touserdata(L, 1));
	inst->endFrame();
	return 0;
...
static int Polycore_Resource_get_platformData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Resource *inst = (Resource*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->platformData) {
		lua_pushnil(L);
...
static int Polycore_ScriptResourceLoader(lua_State *L) {
	ScriptResourceLoader *inst = new ScriptResourceLoader();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ScriptResourceLoader");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_ScriptResourceLoader_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_ScriptResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ResourcePool_get_reloadResourcesOnModify(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ResourcePool_get_dispatchChangeEvents(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ResourcePool_get_resourceSubscribers(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ResourcePool_get_deleteOnUnsubscribe(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ResourcePool_set_reloadResourcesOnModify(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_ResourcePool_set_dispatchChangeEvents(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_ResourcePool_set_resourceSubscribers(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_ResourcePool_set_deleteOnUnsubscribe(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_ResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TSTRING);
	String name = String(lua_tostring(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ResourcePool");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_ResourcePool_setFallbackPool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourcePool_addResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_ResourcePool_removeResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Resource* resource = (Resource*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourcePool_hasResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Resource* resource = (Resource*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourcePool_loadResourcesFromFolder(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_ResourcePool_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String path = String(lua_tostring(L, 2));
...
static int Polycore_ResourcePool_loadResourceWithName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String path = String(lua_tostring(L, 2));
...
static int Polycore_ResourcePool_getResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_ResourcePool_getName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->getName().c_str());
	return 1;
...
static int Polycore_ResourcePool_setName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_ResourcePool_getResourceByPath(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String resourcePath = String(lua_tostring(L, 2));
...
static int Polycore_ResourcePool_Update(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int elapsed = lua_tointeger(L, 2);
...
static int Polycore_ResourcePool_getResources(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int resourceType = lua_tointeger(L, 2);
...
static int Polycore_ResourcePool_checkForChangedFiles(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourcePool *inst = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_ResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ResourceManager_getGlobalPool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ResourceManager_getResourcePoolByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_ResourceManager_addResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_ResourceManager_getResourceLoaderForExtension(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_ResourceManager_removeResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourceLoader* loader = (ResourceLoader*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourceManager_getNumResourceLoaders(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ResourceManager_getResourceLoaderAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_ResourceManager_addResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourceManager_removeResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourceManager_subscribeToResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ResourceManager_unsubscibeFromResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ResourceManager *inst = (ResourceManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_FontResourceLoader(lua_State *L) {
	FontResourceLoader *inst = new FontResourceLoader();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.FontResourceLoader");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_FontResourceLoader_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_FontResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ProgramResourceLoader(lua_State *L) {
	ProgramResourceLoader *inst = new ProgramResourceLoader();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ProgramResourceLoader");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_ProgramResourceLoader_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_ProgramResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_MeshResourceLoader(lua_State *L) {
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.MeshResourceLoader");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_MeshResourceLoader_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_MeshResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_MaterialResourceLoader(lua_State *L) {
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.MaterialResourceLoader");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_MaterialResourceLoader_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_MaterialResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_TextureResourceLoader(lua_State *L) {
	TextureResourceLoader *inst = new TextureResourceLoader();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.TextureResourceLoader");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_TextureResourceLoader_loadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_TextureResourceLoader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Scene_get_useClearDepth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Scene_get_rootEntity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Scene_get_sceneMouseRect(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_Scene_get_remapMouse(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Scene_get_constrainPickingToViewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Scene_set_useClearDepth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Scene_set_rootEntity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Scene_set_sceneMouseRect(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Rectangle *argInst = (Rectangle*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Scene_set_remapMouse(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Scene_set_constrainPickingToViewport(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Scene_setSceneType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int newType = lua_tointeger(L, 2);
...
static int Polycore_Scene_fixedUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	inst->fixedUpdate();
	return 0;
...
static int Polycore_Scene_Render(lua_State *L) {
	...
	luaL_checktype(L, 5, LUA_TBOOLEAN);
	bool s_endLights = lua_toboolean(L, 5) != 0;
	inst->Render(targetCamera, targetFramebuffer, overrideMaterial, s_endLights);
	return 0;
}

static int Polycore_Scene_setOverrideMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Material* material = (Material*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Scene_projectRayFromCameraAndViewportCoordinate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Camera* camera = (Camera*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Scene_doVisibilityChecking(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_Scene_doesVisibilityChecking(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene *inst = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstanceResourceEntry(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SceneEntityInstanceResourceEntry");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SceneEntityInstanceResourceEntry_getInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneEntityInstanceResourceEntry_reloadResource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceResourceEntry *inst = (SceneEntityInstanceResourceEntry*) *((PolyBase**)lua_touserdata(L, 1));
	inst->reloadResource();
	return 0;
...
static int Polycore_delete_SceneEntityInstanceResourceEntry(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneEntityInstance_get_cloneUsingReload(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneEntityInstance_get_fileName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->fileName.c_str());
	return 1;
...
static int Polycore_SceneEntityInstance_set_cloneUsingReload(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneEntityInstance_set_fileName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->fileName = param;
...
static int Polycore_SceneEntityInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene* parentScene = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SceneEntityInstance");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SceneEntityInstance_BlankSceneEntityInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Scene* parentScene = (Scene*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstance_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneEntityInstance_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_reloadEntityInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstance_clearInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	inst->clearInstance();
	return 0;
...
static int Polycore_SceneEntityInstance_parseObjectIntoCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ObjectEntry* entry = (ObjectEntry*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_loadObjectEntryIntoEntity(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ObjectEntry* entry = (ObjectEntry*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_loadFromFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_SceneEntityInstance_applySceneMesh(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ObjectEntry* entry = (ObjectEntry*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_linkResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_getNumLinkedResourePools(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstance_getLinkedResourcePoolAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SceneEntityInstance_unlinkResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ResourcePool* pool = (ResourcePool*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_getResourceEntry(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstance_getTopLevelResourcePool(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstance_hasLayerID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	char layerID = *(char*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstance_getNumLayers(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneEntityInstance_getLayerAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SceneEntityInstance_removeLayer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneEntityInstance_createNewLayer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_SceneEntityInstance_getFileName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance *inst = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_SceneEntityInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneEntityInstanceLayer_get_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneEntityInstanceLayer_get_layerID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->layerID;
...
static int Polycore_SceneEntityInstanceLayer_get_visible(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushboolean(L, inst->visible);
	return 1;
...
static int Polycore_SceneEntityInstanceLayer_get_instance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->instance) {
		lua_pushnil(L);
...
static int Polycore_SceneEntityInstanceLayer_set_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->name = param;
...
static int Polycore_SceneEntityInstanceLayer_set_layerID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	char *argInst = (char*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneEntityInstanceLayer_set_visible(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->visible = param;
...
static int Polycore_SceneEntityInstanceLayer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstance* instance = (SceneEntityInstance*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SceneEntityInstanceLayer");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SceneEntityInstanceLayer_setLayerVisibility(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneEntityInstanceLayer *inst = (SceneEntityInstanceLayer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_delete_SceneEntityInstanceLayer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneImage(lua_State *L) {
	luaL_checktype(L, 1, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 1));
	SceneImage *inst = new SceneImage(fileName);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SceneImage");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SceneImage_SceneImageWithImage(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneImage_SceneImageWithTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneImage_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneImage_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneImage *inst = (SceneImage*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneImage_setImageCoordinates(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneImage *inst = (SceneImage*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_SceneImage_getImageWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneImage *inst = (SceneImage*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneImage_getImageHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneImage *inst = (SceneImage*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_SceneImage(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneLabel_get_positionAtBaseline(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneLabel_set_positionAtBaseline(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneLabel_getText(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneLabel_setLabelActualHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneLabel_getLabelActualHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneLabel_getTextWidthForString(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String text = String(lua_tostring(L, 2));
...
static int Polycore_SceneLabel_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneLabel_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneLabel_updateFromLabel(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLabel *inst = (SceneLabel*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneLight_getShadowMapFOV(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneLight_getShadowMapResolution(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneLight_setLightType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneLight_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneLight_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneLight_getParentScene(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase *ptrRetVal = (PolyBase*)inst->getParentScene();
	if(ptrRetVal == NULL) {
...
static int Polycore_SceneLight_setParentScene(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Scene* scene = (Scene*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneLight_getSpotlightCamera(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneLight_getLightInfo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneLight *inst = (SceneLight*) *((PolyBase**)lua_touserdata(L, 1));
	LightInfo *retInst = new LightInfo();
	*retInst = inst->getLightInfo();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.LightInfo");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}
...
static int Polycore_SceneCurve_get_renderCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneCurve_get_curveResolution(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneCurve_set_renderCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneCurve_set_curveResolution(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_SceneCurve(lua_State *L) {
	SceneCurve *inst = new SceneCurve();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SceneCurve");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SceneCurve_SceneCurveWithCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneCurve_getWorldPointAt(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number t = lua_tonumber(L, 2);
...
static int Polycore_SceneCurve_Update(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
	inst->Update();
	return 0;
...
static int Polycore_SceneCurve_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneCurve_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneCurve_getCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneCurve *inst = (SceneCurve*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_SceneCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SceneManager_fixedUpdate(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneManager *inst = (SceneManager*) *((PolyBase**)lua_touserdata(L, 1));
	inst->fixedUpdate();
	return 0;
...
static int Polycore_SceneManager_setRenderer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneManager *inst = (SceneManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Renderer* r_enderer = (Renderer*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneMesh_get_pointSmooth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_get_useGeometryHitDetection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_get_alphaTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushboolean(L, inst->alphaTest);
	return 1;
...
static int Polycore_SceneMesh_get_backfaceCulled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_get_sendBoneMatricesToMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_set_pointSmooth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneMesh_set_useGeometryHitDetection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneMesh_set_alphaTest(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->alphaTest = param;
...
static int Polycore_SceneMesh_set_backfaceCulled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneMesh_set_sendBoneMatricesToMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneMesh_getShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SceneMesh_getNumShaderPasses(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getNumShaderPasses());
	return 1;
...
static int Polycore_SceneMesh_addShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	ShaderPass pass = *(ShaderPass*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneMesh_removeShaderPass(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int shaderIndex = lua_tointeger(L, 2);
...
static int Polycore_SceneMesh_rebuildAttributes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_applySkeletonLocally(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_setLineWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneMesh_getFilename(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->getFilename().c_str());
	return 1;
...
static int Polycore_SceneMesh_setFilename(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_SceneMesh_loadFromFile(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_SceneMesh_customHitDetection(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Ray ray = *(Ray*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneMesh_setForceMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
...
static int Polycore_SceneMesh_getForceMaterial(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneMesh_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneMesh_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneMesh *inst = (SceneMesh*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_ScenePrimitive_setPrimitiveOptions(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ScenePrimitive_recreatePrimitive(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_getPrimitiveType(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_getPrimitiveParameter1(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_getPrimitiveParameter2(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_getPrimitiveParameter3(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_getPrimitiveParameter4(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_getPrimitiveParameter5(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ScenePrimitive_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_ScenePrimitive_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ScenePrimitive *inst = (ScenePrimitive*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneRenderTexture_get_enabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneRenderTexture_set_enabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneRenderTexture *inst = (SceneRenderTexture*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->enabled = param;
...
static int Polycore_SceneRenderTexture_Render(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneRenderTexture *inst = (SceneRenderTexture*) *((PolyBase**)lua_touserdata(L, 1));
	inst->Render();
	return 0;
...
static int Polycore_SceneRenderTexture_saveToImage(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneRenderTexture *inst = (SceneRenderTexture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSound_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSound *inst = (SceneSound*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool deepClone = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneSound_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSound *inst = (SceneSound*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneSound_isDirectionalSound(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSound *inst = (SceneSound*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSound_setDirectionalSound(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSound *inst = (SceneSound*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneSound_setLoopOnLoad(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSound *inst = (SceneSound*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneSound_getLoopOnLoad(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSound *inst = (SceneSound*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet* spriteSet = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	SceneSprite *inst = new SceneSprite(spriteSet);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SceneSprite");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SceneSprite_Clone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SceneSprite_applyClone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Entity* clone = (Entity*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneSprite_getSpriteSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite_getCurrentSprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite_setSpriteSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneSprite_setSpriteByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_SceneSprite_setCurrentFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SceneSprite_getCurrentFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite_Update(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	inst->Update();
	return 0;
...
static int Polycore_SceneSprite_Render(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	GPUDrawBuffer* buffer = (GPUDrawBuffer*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SceneSprite_getSpriteBoundingBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SceneSprite_setPaused(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_SceneSprite_isPaused(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite_setSprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneSprite_setSpriteState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SceneSprite_setSpriteStateByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_SceneSprite_getCurrentSpriteState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite_getStartOnRandomFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SceneSprite_setStartOnRandomFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SceneSprite *inst = (SceneSprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
	bool val = lua_toboolean(L, 2) != 0;
...
static int Polycore_delete_SceneSprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Sprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TSTRING);
	String name = String(lua_tostring(L, 1));
	Sprite *inst = new Sprite(name);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.Sprite");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_Sprite_getName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Sprite_setName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_Sprite_addSpriteState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_Sprite_removeSpriteState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	SpriteState* state = (SpriteState*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Sprite_getNumStates(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Sprite_getState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_Sprite_getStateByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_Sprite_setParentSpritSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	SpriteSet* spriteSet = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Sprite_getParentSpriteSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sprite *inst = (Sprite*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_delete_Sprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
	delete ((Sprite*) *inst);
	*inst = NULL;
...
static int Polycore_SpriteSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SpriteSet");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SpriteSet_setTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SpriteSet_getTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteSet_loadTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_SpriteSet_addSpriteEntry(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SpriteSet_getNumSpriteEntries(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteSet_getSpriteEntry(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SpriteSet_removeSprite(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SpriteSet_loadSpriteSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String fileName = String(lua_tostring(L, 2));
...
static int Polycore_SpriteSet_addSpriteFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SpriteSet_getNumFrames(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteSet_getSpriteFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
	...
	*retInst = inst->getSpriteFrame(index);
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	luaL_getmetatable(L, "Polycore.SpriteFrame");
	lua_setmetatable(L, -2);
	*userdataPtr = (PolyBase*)retInst;
	return 1;
}

static int Polycore_SpriteSet_getSpriteFrameByID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SpriteSet_removeFrameByID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int frameID = lua_tointeger(L, 2);
...
static int Polycore_SpriteSet_setSpriteFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	SpriteFrame frame = *(SpriteFrame*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SpriteSet_clearFrames(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	inst->clearFrames();
	return 0;
...
static int Polycore_SpriteSet_createGridFrames(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SpriteSet_createFramesFromIslands(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SpriteSet_getSpriteByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet *inst = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String spriteName = String(lua_tostring(L, 2));
...
static int Polycore_delete_SpriteSet(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SpriteFrame_get_coordinates(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SpriteFrame_get_anchorPoint(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteFrame *inst = (SpriteFrame*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_SpriteFrame_get_frameID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteFrame *inst = (SpriteFrame*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteFrame_set_coordinates(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteFrame *inst = (SpriteFrame*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Rectangle *argInst = (Rectangle*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SpriteFrame_set_anchorPoint(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteFrame *inst = (SpriteFrame*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector2 *argInst = (Vector2*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_SpriteFrame_set_frameID(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteFrame *inst = (SpriteFrame*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->frameID = param;
...
static int Polycore_delete_SpriteFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SpriteState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteSet* spriteSet = (SpriteSet*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.SpriteState");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_SpriteState_setName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_SpriteState_getName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->getName().c_str());
	return 1;
...
static int Polycore_SpriteState_getNumFrameIDs(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteState_getFrameIDAtIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SpriteState_getMeshForFrameIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SpriteState_insertFrame(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_SpriteState_removeFrameByIndex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int frameIndex = lua_tointeger(L, 2);
...
static int Polycore_SpriteState_clearFrames(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	inst->clearFrames();
	return 0;
...
static int Polycore_SpriteState_setPixelsPerUnit(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SpriteState_getPixelsPerUnit(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteState_rebuildStateMeshes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteState_setStateFPS(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SpriteState_getStateFPS(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SpriteState_getLargestFrameBoundingBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	Vector3 *retInst = new Vector3();
...
static int Polycore_SpriteState_setBoundingBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SpriteState_getBoundingBox(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	Vector2 *retInst = new Vector2();
...
static int Polycore_SpriteState_getSpriteOffset(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	Vector2 *retInst = new Vector2();
...
static int Polycore_SpriteState_setSpriteOffset(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SpriteState *inst = (SpriteState*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_delete_SpriteState(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_JSScriptInstance_get_objectRef(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_JSScriptInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_LuaScriptInstance_get_tableRef(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_LuaScriptInstance_set_tableRef(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LuaScriptInstance *inst = (LuaScriptInstance*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->tableRef = param;
...
static int Polycore_delete_LuaScriptInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ScriptInstance_get_script(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_delete_ScriptInstance(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ProgramParam_get_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ProgramParam_get_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramParam *inst = (ProgramParam*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->type);
	return 1;
...
static int Polycore_ProgramParam_get_platformData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramParam *inst = (ProgramParam*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->platformData) {
		lua_pushnil(L);
...
static int Polycore_ProgramParam_get_globalParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramParam *inst = (ProgramParam*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->globalParam) {
		lua_pushnil(L);
...
static int Polycore_ProgramParam_set_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramParam *inst = (ProgramParam*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->name = param;
...
static int Polycore_ProgramParam_set_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramParam *inst = (ProgramParam*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->type = param;
...
static int Polycore_ProgramParam(lua_State *L) {
	ProgramParam *inst = new ProgramParam();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ProgramParam");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_ProgramParam_createParamData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TNUMBER);
	int type = lua_tointeger(L, 1);
...
static int Polycore_delete_ProgramParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ProgramAttribute_get_size(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ProgramAttribute_get_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramAttribute *inst = (ProgramAttribute*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->name.c_str());
	return 1;
...
static int Polycore_ProgramAttribute_get_platformData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramAttribute *inst = (ProgramAttribute*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->platformData) {
		lua_pushnil(L);
...
static int Polycore_ProgramAttribute_set_size(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramAttribute *inst = (ProgramAttribute*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->size = param;
...
static int Polycore_ProgramAttribute_set_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ProgramAttribute *inst = (ProgramAttribute*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->name = param;
...
static int Polycore_ProgramAttribute(lua_State *L) {
	ProgramAttribute *inst = new ProgramAttribute();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ProgramAttribute");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_ProgramAttribute(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ShaderRenderTarget_get_id(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ShaderRenderTarget_get_width(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderRenderTarget_get_height(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderRenderTarget_get_sizeMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderRenderTarget_get_buffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->buffer) {
		lua_pushnil(L);
...
static int Polycore_ShaderRenderTarget_get_normalizedWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderRenderTarget_get_normalizedHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderRenderTarget_set_id(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->id = param;
...
static int Polycore_ShaderRenderTarget_set_width(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->width = param;
...
static int Polycore_ShaderRenderTarget_set_height(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->height = param;
...
static int Polycore_ShaderRenderTarget_set_sizeMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->sizeMode = param;
...
static int Polycore_ShaderRenderTarget_set_normalizedWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_ShaderRenderTarget_set_normalizedHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderRenderTarget *inst = (ShaderRenderTarget*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_ShaderRenderTarget(lua_State *L) {
	ShaderRenderTarget *inst = new ShaderRenderTarget();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.ShaderRenderTarget");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_ShaderRenderTarget(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_RenderTargetBinding_get_id(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RenderTargetBinding_get_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderTargetBinding *inst = (RenderTargetBinding*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->name.c_str());
	return 1;
...
static int Polycore_RenderTargetBinding_get_mode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderTargetBinding *inst = (RenderTargetBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderTargetBinding_get_buffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderTargetBinding *inst = (RenderTargetBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->buffer) {
		lua_pushnil(L);
...
static int Polycore_RenderTargetBinding_set_id(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderTargetBinding *inst = (RenderTargetBinding*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->id = param;
...
static int Polycore_RenderTargetBinding_set_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderTargetBinding *inst = (RenderTargetBinding*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->name = param;
...
static int Polycore_RenderTargetBinding_set_mode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderTargetBinding *inst = (RenderTargetBinding*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->mode = param;
...
static int Polycore_delete_RenderTargetBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Shader_get_numPointLights(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Shader_get_vertexProgram(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Shader_get_fragmentProgram(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Shader_get_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushstring(L, inst->name.c_str());
	return 1;
...
static int Polycore_Shader_set_numPointLights(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_Shader_set_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->name = param;
...
static int Polycore_Shader_getParamPointer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_Shader_getAttribPointer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Shader *inst = (Shader*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_LocalShaderParam_get_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->type);
	return 1;
...
static int Polycore_LocalShaderParam_get_ownsPointer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LocalShaderParam_get_arraySize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LocalShaderParam_get_param(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->param) {
		lua_pushnil(L);
...
static int Polycore_LocalShaderParam_set_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->type = param;
...
static int Polycore_LocalShaderParam_set_ownsPointer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_LocalShaderParam_set_arraySize(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_LocalShaderParam(lua_State *L) {
	LocalShaderParam *inst = new LocalShaderParam();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.LocalShaderParam");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_LocalShaderParam_Copy(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase *ptrRetVal = (PolyBase*)inst->Copy();
	if(ptrRetVal == NULL) {
...
static int Polycore_LocalShaderParam_getMatrix4(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	Matrix4 *retInst = new Matrix4();
...
static int Polycore_LocalShaderParam_setMatrix4(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_LocalShaderParam_setTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Texture* texture = (Texture*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_LocalShaderParam_getTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase *ptrRetVal = (PolyBase*)inst->getTexture();
	if(ptrRetVal == NULL) {
...
static int Polycore_LocalShaderParam_setCubemap(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_LocalShaderParam_getCubemap(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_LocalShaderParam_setParamValueFromString(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	LocalShaderParam *inst = (LocalShaderParam*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int type = lua_tointeger(L, 2);
...
static int Polycore_AttributeBinding_get_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_AttributeBinding_get_vertexData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AttributeBinding *inst = (AttributeBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->vertexData) {
		lua_pushnil(L);
...
static int Polycore_AttributeBinding_get_attribute(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AttributeBinding *inst = (AttributeBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->attribute) {
		lua_pushnil(L);
...
static int Polycore_AttributeBinding_get_enabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AttributeBinding *inst = (AttributeBinding*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushboolean(L, inst->enabled);
	return 1;
...
static int Polycore_AttributeBinding_set_name(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AttributeBinding *inst = (AttributeBinding*) *((PolyBase**)lua_touserdata(L, 1));
	String param = lua_tostring(L, 2);
	inst->name = param;
...
static int Polycore_AttributeBinding_set_enabled(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AttributeBinding *inst = (AttributeBinding*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
	inst->enabled = param;
...
static int Polycore_AttributeBinding(lua_State *L) {
	AttributeBinding *inst = new AttributeBinding();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.AttributeBinding");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_delete_AttributeBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_ShaderBinding_get_resetAttributes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_ShaderBinding_get_targetShader(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderBinding_get_accessMutex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->accessMutex) {
		lua_pushnil(L);
...
static int Polycore_ShaderBinding_set_resetAttributes(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_ShaderBinding_copyTo(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_ShaderBinding_addParamPointer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int type = lua_tointeger(L, 2);
...
static int Polycore_ShaderBinding_removeParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_ShaderBinding_loadTextureForParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_ShaderBinding_setTextureForParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String paramName = String(lua_tostring(L, 2));
...
static int Polycore_ShaderBinding_setCubemapForParam(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String paramName = String(lua_tostring(L, 2));
...
static int Polycore_ShaderBinding_getNumAttributeBindings(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_ShaderBinding_getAttributeBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	int index = lua_tointeger(L, 2);
...
static int Polycore_ShaderBinding_addAttributeBinding(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_ShaderBinding_getAttributeBindingByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	ShaderBinding *inst = (ShaderBinding*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_SkeletonAnimation_Reset(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SkeletonAnimation *inst = (SkeletonAnimation*) *((PolyBase**)lua_touserdata(L, 1));
	inst->Reset();
	return 0;
...
static int Polycore_SkeletonAnimation_setWeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SkeletonAnimation *inst = (SkeletonAnimation*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SkeletonAnimation_getWeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SkeletonAnimation *inst = (SkeletonAnimation*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SkeletonAnimation_isPlaying(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SkeletonAnimation *inst = (SkeletonAnimation*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Skeleton_playAnimationByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
...
static int Polycore_Skeleton_setBaseAnimationByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String animName = String(lua_tostring(L, 2));
...
static int Polycore_Skeleton_setBaseAnimation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	SkeletonAnimation* animation = (SkeletonAnimation*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Skeleton_stopAllAnimations(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Skeleton_getBaseAnimation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Skeleton_stopAnimationByName(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TSTRING);
	String name = String(lua_tostring(L, 2));
...
static int Polycore_Skeleton_stopAnimation(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	SkeletonAnimation* animation = (SkeletonAnimation*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Skeleton_addBone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Bone* bone = (Bone*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Skeleton_removeBone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Bone* bone = (Bone*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_Skeleton_getBoneIndexByBone(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Skeleton *inst = (Skeleton*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Bone* bone = (Bone*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_BoneTrack_get_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)&inst->position;
...
static int Polycore_BoneTrack_get_scale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
...
static int Polycore_BoneTrack_get_quatCurve(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->quatCurve) {
		lua_pushnil(L);
...
static int Polycore_BoneTrack_get_weight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_BoneTrack_set_position(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_BoneTrack_set_scale(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Vector3 *argInst = (Vector3*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_BoneTrack_set_weight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->weight = param;
...
static int Polycore_BoneTrack_Reset(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	BoneTrack *inst = (BoneTrack*) *((PolyBase**)lua_touserdata(L, 1));
	inst->Reset();
	return 0;
...
static int Polycore_Sound_getSampleAsNumber(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Sound_isLooped(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sound *inst = (Sound*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Sound_getFrequency(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sound *inst = (Sound*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Sound_updateStream(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Sound *inst = (Sound*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_AudioStreamingSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TNUMBER);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.AudioStreamingSource");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_AudioStreamingSource_getNumChannels(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_AudioStreamingSource_getFrequency(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AudioStreamingSource *inst = (AudioStreamingSource*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getFrequency());
	return 1;
...
static int Polycore_delete_AudioStreamingSource(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_AudioMixer_get_globalVolume(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_AudioMixer_get_mixerMutex(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AudioMixer *inst = (AudioMixer*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->mixerMutex) {
		lua_pushnil(L);
...
static int Polycore_AudioMixer_set_globalVolume(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AudioMixer *inst = (AudioMixer*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
...
static int Polycore_AudioMixer(lua_State *L) {
	AudioMixer *inst = new AudioMixer();
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.AudioMixer");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_AudioMixer_mixIntoBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	AudioMixer *inst = (AudioMixer*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_delete_AudioMixer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_SoundManager_recordSound(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SoundManager *inst = (SoundManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_SoundManager_stopRecording(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SoundManager *inst = (SoundManager*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_SoundManager_setAudioInterface(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SoundManager *inst = (SoundManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SoundManager_Update(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SoundManager *inst = (SoundManager*) *((PolyBase**)lua_touserdata(L, 1));
	inst->Update();
	return 0;
...
static int Polycore_SoundManager_registerSound(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SoundManager *inst = (SoundManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_SoundManager_unregisterSound(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	SoundManager *inst = (SoundManager*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
	Sound* sound = (Sound*) *((PolyBase**)lua_touserdata(L, 2));
...
static int Polycore_String_toNumber(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	String *inst = (String*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_String_toInteger(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	String *inst = (String*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderBuffer_get_colorTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_RenderBuffer_get_depthTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderBuffer *inst = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderBuffer_get_platformData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderBuffer *inst = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	if(!inst->platformData) {
		lua_pushnil(L);
...
static int Polycore_RenderBuffer_get_depthBufferPlatformData(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderBuffer *inst = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_RenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TNUMBER);
	int width = lua_tointeger(L, 1);
	luaL_checktype(L, 2, LUA_TNUMBER);
	int height = lua_tointeger(L, 2);
	...
	PolyBase **userdataPtr = (PolyBase**)lua_newuserdata(L, sizeof(PolyBase*));
	*userdataPtr = (PolyBase*)inst;
	luaL_getmetatable(L, "Polycore.RenderBuffer");
	lua_setmetatable(L, -2);
	return 1;
}

static int Polycore_RenderBuffer_getWidth(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderBuffer *inst = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getWidth());
	return 1;
...
static int Polycore_RenderBuffer_getHeight(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	RenderBuffer *inst = (RenderBuffer*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->getHeight());
	return 1;
...
static int Polycore_delete_RenderBuffer(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
...
static int Polycore_Texture_get_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushinteger(L, inst->type);
	return 1;
...
static int Polycore_Texture_get_filteringMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Texture_get_createMipmaps(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Texture_get_anisotropy(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Texture_get_framebufferTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Texture_get_depthTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Texture_set_type(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
	inst->type = param;
...
static int Polycore_Texture_set_filteringMode(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_Texture_set_createMipmaps(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Texture_set_anisotropy(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	int param = lua_tointeger(L, 2);
...
static int Polycore_Texture_set_framebufferTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Texture_set_depthTexture(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	bool param = lua_toboolean(L, 2) != 0;
...
static int Polycore_Texture_setCreateMipmaps(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TBOOLEAN);
...
static int Polycore_Texture_getCreateMipmaps(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Texture *inst = (Texture*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Vector3_lengthSquared(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector3 *inst = (Vector3*) *((PolyBase**)lua_touserdata(L, 1));
...
static int Polycore_Vector3_setLength(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector3 *inst = (Vector3*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
...
static int Polycore_Vector4_get_x(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
...
static int Polycore_Vector4_get_y(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushnumber(L, inst->y);
	return 1;
...
static int Polycore_Vector4_get_z(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushnumber(L, inst->z);
	return 1;
...
static int Polycore_Vector4_get_w(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	lua_pushnumber(L, inst->w);
	return 1;
...
static int Polycore_Vector4_set_x(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->x = param;
...
static int Polycore_Vector4_set_y(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->y = param;
...
static int Polycore_Vector4_set_z(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->z = param;
...
static int Polycore_Vector4_set_w(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	Number param = lua_tonumber(L, 2);
	inst->w = param;
...
static int Polycore_Vector4(lua_State *L) {
	luaL_checktype(L, 1, LUA_TNUMBER);
	Number x = lua_tonumber(L, 1);
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number y = lua_tonumber(L, 2);
...
static int Polycore_Vector4_set(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TNUMBER);
	Number x = lua_tonumber(L, 2);
...
static int Polycore_Vector4_dot(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	Vector4 *inst = (Vector4*) *((PolyBase**)lua_touserdata(L, 1));
	luaL_checktype(L, 2, LUA_TUSERDATA);
...
static int Polycore_delete_Vector4(lua_State *L) {
	luaL_checktype(L, 1, LUA_TUSERDATA);
	PolyBase **inst = (PolyBase**)lua_touserdata(L, 1);
	delete ((Vector4*) *inst);
	*inst = NULL;
